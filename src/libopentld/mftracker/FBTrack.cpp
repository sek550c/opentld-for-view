            ...
            float *scaleshift)
{
    ...
    int nlkPoints; // No of points successfully tracked by LK
    CvPoint2D32f *startPoints; // points remained after LK
    CvPoint2D32f *targetPoints; // points remained after LK
    float *fbLkCleaned;
    float *nccLkCleaned;
    int i, M;
    int nRealPoints;
